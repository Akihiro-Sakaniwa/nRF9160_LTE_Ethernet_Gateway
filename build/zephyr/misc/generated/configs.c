...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_MAX_FDS, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SPARKFUN_THING_PLUS_NRF9160_NS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIM_SORACOM_PLAN_D, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF91_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF91_LOG_LEVEL, 3);
